...
const galleryItems = [
  {
    image: "/images/gallery/before1.jpg",
    alt: "Before",
    label: "BEFORE",
    bg: "bg-red-600",
    text: "text-white",
  ...
  {
    image: "/images/gallery/after1.jpg",
    alt: "After",
    label: "AFTER",
    bg: "bg-yellow-500",
    text: "text-black",
  ...
  {
    image: "/images/gallery/before&after1.jpg",
    alt: "Before & After",
    label: "BEFORE & AFTER",
    bg: "bg-black",
    text: "text-white",
  ...
  {
    image: "/images/gallery/before2.jpg",
    alt: "Before",
    label: "BEFORE",
    bg: "bg-red-600",
    text: "text-white",
  ...
  {
    image: "/images/gallery/after2.jpg",
    alt: "After",
    label: "AFTER",
    bg: "bg-yellow-500",
    text: "text-black",
